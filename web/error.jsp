<%-- 
    Document   : error
    Created on : Oct 1, 2016, 7:06:09 PM
...
<div class="container">
		...
		<div class="col-md-8 account-top">
                    ...
                    <h1 style="margin-top: 200px;">Username or password invalid!!!</h1>
                    
                    <a href="dangky.jsp" class="create">Create an account</a>
		</div>
		<div class="col-md-4 left-account ">
			<a href="dangky.jsp"><img class="img-responsive " src="teamplate/images/ss.jpg" alt=""></a>
			<div class="five">
