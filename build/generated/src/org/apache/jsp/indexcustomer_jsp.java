...
public final class indexcustomer_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t<div class=\"container\">\n");
      out.write("\t\t\t  <script src=\"teamplate/js/responsiveslides.min.js\"></script>\n");
      out.write("  <script>\n");
      out.write("    $(function () {\n");
      ...
      out.write("                                                    <h2> NGÔN NGỮ THIẾT KẾ QUEN THUỘC</h2>\n");
      out.write("\t\t\t\t\t\t<p>MẶT LƯNG ĐƯỢC BO CONG GIÚP NGƯỜI DÙNG CẦM GIỮ DỄ DÀNG ,HỆ THỐNG CAMERA ĐƯỢC LÀM GỌN VÀ BỚT LỒI LÕM HƠN </p>\n");
      out.write("\t\t\t\t\t\t<a href=\"indexcart.jsp\">Learn More</a>\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\n");
      out.write("\t\t\t\t</li>\n");
      out.write("\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\n");
      out.write("\t\t\t\t\t\t<div class=\"banner-text\">\n");
      out.write("\t\t\t\t\t\t\t <h2> NỀN TẢNG ĐIỀU HÀNH MỚI CHO THỜI LƯỢNG PIN TỐT HƠN</h2>\n");
      out.write("\t\t\t\t\t\t<p>HỆ ĐIỀU HÀNH ANDROID 6.0 MASHMALLOW  MỚI NHẤT HIỆN NAY KẾT HỢP VỚI CÔNG NGHỆ MÀN HÌNH SUPER AMOLED VÀ VI XỬ LÝ TIẾT KIỆM ĐIỆN NĂNG </p>\n");
      out.write("                                                <\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"indexcart.jsp\">Learn More</a>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t</div>\n");
      ...
      out.write("\t\t\t\t<li>\n");
      out.write("\t\t\t\t\t\t<div class=\"banner-text\">\n");
      out.write("\t\t\t\t\t\t\t <h2>  BỔ SUNG KHẢ NĂNG CHỐNG NƯỚC HIỆU QUẢ</h2>\n");
      out.write("\t\t\t\t\t\t<p>KHẢ NĂNG CHỐNG NƯỚC VÀ BỤI ĐẠT TIÊU CHUẨN  IP68 SẼ MANG ĐẾN SỰ YÊN TÂM KHI SỬ DỤNG MÁY TRONG ĐIỀU KIỆN ẨM ƯỚT VÀ GIÚP NGƯỜI DÙNG VỆ SINH MÁY DỄ DÀNG HƠN </p>\n");
      out.write("\t\t\t\t\t\t\t\t<a href=\"indexcart.jsp\">Learn More</a>\n");
      out.write("\n");
      out.write("\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\n");
      ...
      out.write("\t\t<h1> HIGH QUALITY</h1>\n");
      out.write("\t\t<div class=\"grid-in\">\n");
      out.write("\t\t\t<div class=\"col-md-4 grid-top\">\n");
      out.write("                            <a href=\"indexcart.jsp\" class=\"b-link-stripe b-animate-go  thickbox\"><img class=\"img-responsive\" src=\"teamplate/images/pl.jpg\" alt=\"\">\n");
      ...
      out.write("\t\t\n");
      out.write("\n");
      out.write("\t\t\t<p><a href=\"indexcart.jsp\"></a></p>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<div class=\"col-md-4 grid-top\">\n");
      out.write("\t\t\t\t<a href=\"indexcart.jsp\" class=\"b-link-stripe b-animate-go  thickbox\"><img class=\"img-responsive\" src=\"teamplate/images/pl1.jpg\" alt=\"\">\n");
      out.write("\t\t\t\t\t<div class=\"b-wrapper\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<h3 class=\"b-animate b-from-left    b-delay03 \">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<span>Smart Phone</span>\t\n");
      out.write("\t\t\t\t\t\t\t\t\t</h3>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</a>\n");
      out.write("\t\t\t<p><a href=\"indexcart.jsp\">classical Latin</a></p>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t<div class=\"col-md-4 grid-top\">\n");
      out.write("\t\t\t\t<a href=\"indexcart.jsp\" class=\"b-link-stripe b-animate-go  thickbox\"><img class=\"img-responsive\" src=\"teamplate/images/pi2.jpg\" alt=\"\">\n");
      out.write("\t\t\t\t\t<div class=\"b-wrapper\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<h3 class=\"b-animate b-from-left    b-delay03 \">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<span>Bag</span>\t\n");
      out.write("\t\t\t\t\t\t\t\t\t</h3>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t</a>\n");
      out.write("\t\t\t<p><a href=\"indexcart.jsp\">undoubtable</a></p>\n");
      out.write("\t\t\t</div>\n");
      out.write("\t\t\t\t\t<div class=\"clearfix\"> </div>\n");
      out.write("\t\t</div>\n");
      out.write("\t\t\n");
      ...
      out.write("\t\t\t<a href=\"indexcart.jsp\" class=\"b-link-stripe b-animate-go  thickbox\"><img class=\"img-responsive\" src=\"teamplate/images/d1.jpg\" alt=\"\">\n");
      out.write("\t\t\t\t<div class=\"b-wrapper\">\n");
      ...
      out.write("\t\t\t\t<a href=\"indexcart.jsp\" class=\"b-link-stripe b-animate-go  thickbox\"><img class=\"img-responsive\" src=\"teamplate/images/t2.jpg\" alt=\"\">\n");
      out.write("\t\t\t\t\t<div class=\"b-wrapper\">\n");
      ...
      out.write("\t\t\t\t\t<a href=\"indexcart.jsp\" class=\"b-link-stripe b-animate-go  thickbox\"><img class=\"img-responsive\" src=\"teamplate/images/d3.jpg\" alt=\"\">\n");
      out.write("\t\t\t\t\t\t\t<div class=\"b-wrapper\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<h3 class=\"b-animate b-from-top top-in2   b-delay03 \">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<span>new design</span>\t\n");
      out.write("\t\t\t\t\t\t\t\t\t</h3>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</a>\n");
      out.write("\t\t\t\t\t\n");
      ...
      out.write("\t\t\t\t\t<a href=\"indexcart.jsp\" class=\"b-link-stripe b-animate-go  thickbox\"><img class=\"img-responsive\" src=\"teamplate/images/d4.jpg\" alt=\"\">\n");
      out.write("\t\t\t\t\t\t\t<div class=\"b-wrapper\">\n");
      out.write("\t\t\t\t\t\t\t\t\t<h3 class=\"b-animate b-from-top top-in2   b-delay03 \">\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<span>new style</span>\t\n");
      out.write("\t\t\t\t\t\t\t\t\t</h3>\n");
      out.write("\t\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t</a>\n");
      out.write("\t\t\t\t\t\n");
