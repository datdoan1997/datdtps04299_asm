<%-- 
    Document   : dangky
    Created on : Oct 20, 2016, 12:59:40 PM
...
<html>
    <head>
        ...
        <link href="teamplate/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
        <!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
        <script src="teamplate/js/jquery.min.js"></script>
        <!-- Custom Theme files -->
        <!--theme-style-->
        <link href="teamplate/css/style.css" rel="stylesheet" type="text/css" media="all" />	
        <!--//theme-style-->
        ...
        <script src="teamplate/js/simpleCart.min.js"></script>
    </head>
    <body>
        <!--header-->
        <div class="header">
                ...
                <div class="container">
                    ...
                    <div class="header-left">		
                        <ul>
                            ...
                            <li><a class="lock" href="dangky.jsp"  >Register</a></li>
                            <li>
                            </li>
                ...
                <form action="controllercustomer">
                    <div class="col-md-6 register-top-grid">
                        ...
                        <div>
                            ...
                            <input type="text" name="txtGioiTinh" value=""/> 
                        </div>
                        <div>
